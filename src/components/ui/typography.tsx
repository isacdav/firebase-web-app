...
const Typography = forwardRef<HTMLElement, TypographyProps>(({ className, variant, as, ...props }, ref) => {
  const Comp: any = as ?? (variant ? variantElementMap[variant] : undefined) ?? 'div';
